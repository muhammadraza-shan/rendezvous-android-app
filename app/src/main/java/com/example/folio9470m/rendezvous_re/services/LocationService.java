package com.example.folio9470m.rendezvous_re.services;
...
import com.example.folio9470m.rendezvous_re.Rendezvous;
    ...
    private void getLocation() {
        ...
        mFusedLocationClient.requestLocationUpdates(mLocationRequestHighAccuracy, new LocationCallback() {
                    ...
                    public void onLocationResult(LocationResult locationResult) {
                        ...
                        if (location != null) {
                            LatLong geoPoint = new LatLong(location.getLatitude(), location.getLongitude());
                            String userName;
                            ...
                            UserLocation userLocation = new UserLocation(userName,
                                    geoPoint,
                                    mApp.getUserID());
                ...
                Looper.myLooper()).addOnFailureListener(new OnFailureListener() {
            @Override
    ...
    private void saveUserLocation(final UserLocation userLocation){
        ...
        if(FirebaseAuth.getInstance().getCurrentUser()!= null && FirebaseAuth.getInstance().getUid()!= null){
            if(mApp.getUserID()!=null){
                ...
                locationRef.setValue(userLocation).addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Log.d(TAG, "saveUserLocation: User Location Saved Successfully");
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Log.d(TAG, "onFailure: Unable to save UserLocation"+e.getMessage());
                    }
                });
            }
        }
