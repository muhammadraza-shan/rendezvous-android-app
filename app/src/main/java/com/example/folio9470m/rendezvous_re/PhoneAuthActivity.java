...
public class PhoneAuthActivity extends AppCompatActivity implements
    ...
    private Button mDisplayNameButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDisplayNameField = findViewById(R.id.display_name_text);
        ...
        mDisplayNameButton = findViewById(R.id.display_name_button);
        ...
        mDisplayNameButton.setOnClickListener(this);
    ...
    private void checkIfUserExistsInDatabase(FirebaseUser user) {
        ...
        usersRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(!userExists){
                    User newUser = new User(user.getPhoneNumber(),"noemail",mAuth.getUid(),"phone");
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.signOutButton:
                signOut();
                break;
            case R.id.display_name_button:
                if(mDisplayNameField.getText()!=null && !mDisplayNameField.getText().toString().equals(""))
                {
                    usersRef.child(mAuth.getUid()).child("name").setValue(mDisplayNameField.getText().toString());
                    DynamicToast.makeSuccess(this,"Name set Successfully. Redirecting to Home Screen").show();
                    new Timer().schedule(new TimerTask() {
                        @Override
                        public void run() {
                            startActivity(new Intent(PhoneAuthActivity.this,MainActivity.class));
                    ...
                    mDisplayNameField.setError("Display Name must be set");
                }
        }
    }
}