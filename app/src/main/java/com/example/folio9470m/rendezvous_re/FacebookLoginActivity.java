...
public class FacebookLoginActivity extends AppCompatActivity implements
    ...
    private DatabaseReference totalUsers;
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        checkUserInDatabase(user, token);
                        updateUI(user);
                    } else {
    ...
    private void checkUserInDatabase(FirebaseUser user, AccessToken token) {
        ...
        userDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot userSnapshot : dataSnapshot.getChildren()){
                    ...
                    if(current.getName().equals(user.getDisplayName()))
                        userExists = true;
                }
                if(!userExists){
                    User newUser = new User(user.getDisplayName(),user.getEmail(),mAuth.getUid(),"facebook");
                    userDatabase.child(newUser.getUserID()).setValue(newUser);
                    userDatabase.child(newUser.getUserID()).child("facebookid").setValue(token.getUserId());
                }
            }
